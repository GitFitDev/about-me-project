      ...
      <div>
        <section id="colorlib-hero" className="js-fullheight" data-section="home">
          <div className="flexslider js-fullheight">
            <ul className="slides">
              <li style={{backgroundImage: 'url(images/gymShark.png)'}}>
                    ...
                    <div className="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                      <div className="slider-text-inner">
                        <div className="desc">
                          ...
                          <p><a className="btn btn-primary btn-learn" href="https://www.linkedin.com/in/courtney-revada-luz-3135ba13a/" target="_blank" rel="noopener noreferrer">View Blog <i className="icon-linkedin2" /></a></p>
                        </div>
                      </div>
                    </div>
                  </div>
